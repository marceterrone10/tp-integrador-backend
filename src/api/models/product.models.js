...
export const postProduct = async(nombre, marca, precio, categoria, activo, imagen) => {
    ...
    return await connection.query(sql, [nombre, marca, precio, categoria, activo, imagen]); // ejecutamos la consulta y desestructuramos para obtener las filas
};
...
export const modifyProduct = async(nombre, marca, precio, categoria, activo, imagen, id) => {
    ...
    return await connection.query(sql, [nombre, marca, precio, categoria, activo, imagen, id]); // ejecutamos la consulta y desestructuramos para obtener el resultado
};
